...
class QuickKerasFilter(FilterStrategy):
    ...
    def __init__(self, key: str, config: Configuration, **kwargs: str) -> None:
        ...
        self.rrr_model = tf.keras.models.load_model("C:/Users/Yassine/Desktop/aizynth/transfer/our_model_generator_Acide Carboxylique")
    ...
    def _predict(self, reaction: RetroReaction) -> float:
        ...
        return self.rrr_model.predict([rxn_fp, prod_fp])
